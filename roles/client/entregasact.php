...
<body>
    <div class="container-fluid">
        <div id="sidemenu" class="menu-expanded navigation">
            ...
            <!-- Profile -->
            <div id="profile">
                <div id="photo"><img src="../../img/user-client.png" alt="" width="400px"></div>
            ...
            <nav class="navbar navbar-expand-lg navbar-light bg-light w-100">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    <ul class="navbar-nav ml-auto">
                        ...
                        <li class="nav-item">
                            <a class="nav-link disabled" href="#">Cliente / Usuario</a>
                        </li>
                    </ul>
                </div>
            </nav>
                            ...
                            <div class="modal-body">
                                <div class="row">
                                    <div class="col-md-6">
                                        ...
                                        <input required type="date" name="fecha" id="fecha" value="<?php echo $fecha; ?>" class="form-control">
                                    </div>
                                    <div class="col-md-6">
                                        <label for="h-servicio"><i class="fa fa-clock-o" aria-hidden="true"></i>
                                            Hora de Servicio:</label>
                                        <input required type="time" name="hora" id="hora" value="<?php echo $hora; ?>" class="form-control">
                                    </div>
                                </div>
                                <div class="row mt-4">
                                    <div class="col-md-6">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <input required type="text" name="dir2" id="dir2" value="<?php echo $dir2; ?>" placeholder="EJ: Cll 132 #136-17 bloq 1 apt 1029" class="form-control">
                                    </div>
                                </div>
                                <div class="row mt-4">
                                    <div class="col-md-6">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <input required type="text" name="client" id="client" value="<?php echo $client; ?>" placeholder="EJ: Andres Jimenez" class="form-control">
                                    </div>
                                </div>
                                <div class="row mt-2">
                                    <div class="col-md-6 mt-1">
                                        <label for="telf"><i class="fa fa-phone-square" aria-hidden="true"></i> Telefono:</label>
                                        <input required type="number" name="tel" id="tel" value="<?php echo $tel; ?>" placeholder="EJ: 3224213424" class="form-control">
                                    </div>
                                    <div class="col-md-6 mt-1">
                                    ...
                                    <div class="col-md-6 mt-1">
                                        <label for="a"><i class="fa fa-money" aria-hidden="true"></i>
                                            Cliente:</label>
                                        <input required type="number" disabled name="idCliente" id="idCliente" value="<?php echo $idCliente; ?>" placeholder="EJ: idCliente" class="form-control">
                                    </div>
                                    <div class="col-md-6 mt-1">
                                        <label for="v-pago"><i class="fa fa-money" aria-hidden="true"></i>
                                            Mensajero:</label>
                                    ...
                                    <div class="col-md-12 mt-1">
                                        ...
                                        <select class="form-control" id="est" name="est" aria-label="Default select example" disabled>
