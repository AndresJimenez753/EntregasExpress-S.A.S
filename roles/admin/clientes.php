                    ...
                    <div class="col-md-12">
                        ...
                        <div class="d-flex justify-content-between">
                            ...
                            <div><button type="button" class="btn btn-primary btn-insert" data-toggle="modal"
                                    data-target=".bd-example-modal-lg"><i class="fa fa-user-plus"
                                        aria-hidden="true"></i>
                                    Registrar Cliente</button></div>
                        ...
                        <div class="modal fade bd-example-modal-lg" tabindex="-1" role="dialog"
                            ...
                            <div class="modal-dialog modal-lg">
                                <form action="Insertar.php" method="POST" class=" form-sigin needs-validation"
                                    novalidate>
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            <div class="row">
                                                <div class="col-md-6">
                                                    <label for="validationFormCheck1"><i class="fa fa-id-card"
                                                            aria-hidden="true"></i>
                                                        Numero de Documento:</label>
                                                    <input required type="text" name="doc" id="doc"
                                                        placeholder="EJ: 1001039201" class="form-control">
                                                ...
                                                <div class="col-md-6">
                                                    <label for="validationFormCheck2"><i class="fa fa-truck"
                                                            aria-hidden="true"></i>
                                                        Direccion de Residencia:</label>
                                                    <input required type="text" name="dir" id="dir"
                                                        placeholder="EJ: Cll 132c 134-16 bloq 32 apt 401"
                                                        class="form-control">
                                                    <div class="valid-feedback">
                                                        Campo Aceptado
                                                    </div>
                                            ...
                                            <div class="row mt-4">
                                                <div class="col-md-6">
                                                    <label for="validationFormCheck3"><i class="fa fa-user-circle"
                                                            aria-hidden="true"></i> Nombres:</label>
                                                    <input required type="text" name="nom" id="nom"
                                                        placeholder="EJ: Cristian Alberto" class="form-control"
                                                        autofocus>
                                                    <div class="valid-feedback">
                                                        Campo Aceptado
                                                    </div>
                                                ...
                                                <div class="col-md-6">
                                                    <label for="validationFormCheck4"><i class="fa fa-user-circle"
                                                            aria-hidden="true"></i> Apellidos:</label>
                                                    <input required type="text" name="ape" id="ape"
                                                        placeholder="EJ: Gomez Tabarez" class="form-control">
                                                    <div class="valid-feedback">
                                                        Campo Aceptado
                                                    </div>
                                                    <div class="invalid-feedback">
                                            ...
                                            <div class="row mt-4">
                                                <div class="col-md-6">
                                                    <label for="validationFormCheck5"><i class="fa fa-phone-square"
                                                            aria-hidden="true"></i> Teléfono:</label>
                                                    <input required type="number" name="tel" id="tel"
                                                        placeholder="EJ: 3224314903" class="form-control">
                                                    <div class="valid-feedback">
                                                        Campo Aceptado
                                                    </div>
                                                    <div class="invalid-feedback">
                                                ...
                                                <div class="col-md-6">
                                                    <label for="validationFormCheck6"><i class="fa fa-envelope"
                                                            aria-hidden="true"></i>
                                                        Email:</label>
                                                    <input required type="email" name="cor" id="cor"
                                                        placeholder="EJ: andresjimenez@email.com" class="form-control">
                                                    <div class="valid-feedback">
                                                        Campo Aceptado
                                                    </div>
                                                    <div class="invalid-feedback">
                                                ...
                                                <div class="col-md-6 mt-4">
                                                    <label for="validationFormCheck7"><i class="fa fa-key"
                                                            aria-hidden="true"></i>
                                                        Contraseña:</label>
                                                    <input required type="password" name="con" id="con"
                                                ...
                                                <div class="col-md-6  mt-4">
                                                    <label for="validationFormCheck8" class="form-label" for="nombre">
                                                        Estado:</label>
                        ...
                        <table id="example" class="table table-bordered display nowrap" cellspacing="0" width="100%">
                            ...
                            <tbody>
                                <?php
                                $query = "SELECT * FROM clientes WHERE estado = 'Habilitado'";
                                ...
                                <tr>
                                    ...
                                    <td>
                    </div> <a style="color: green; font-size: 23px;"
                        href="clientesact.php?id=<?php echo $row['idCliente'] ?>"><i class="fa fa-pencil-square"
                            aria-hidden="true"></i></a> <i class="fa fa-minus" aria-hidden="true"></i>
                </div><a style="color: red; font-size: 23px;" href="borrar.php?id=<?php echo $row['idCliente'] ?>"><i
