                                    ...
                                    <div class="modal-body">
                                        <div class="row">
                                            <div class="col-md-6">
                                                ...
                                                <input required type="date" name="fecha" id="fecha" value="<?php echo $fecha; ?>"
                                                    class="form-control">
                                            </div>
                                            <div class="col-md-6">
                                                <label for="h-servicio"><i class="fa fa-clock-o" aria-hidden="true"></i>
                                                    Hora de Servicio:</label>
                                                <input required type="time" name="hora" id="hora" value="<?php echo $hora; ?>"
                                                    class="form-control">
                                            </div>
                                        </div>
                                        <div class="row mt-4">
                                            <div class="col-md-6">
                                                ...
                                                <input required type="text" name="dir" id="dir" value="<?php echo $dir; ?>"
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                <input required type="text" name="dir2" id="dir2" value="<?php echo $dir2; ?>"
                                        ...
                                        <div class="row mt-4">
                                            <div class="col-md-6">
                                                ...
                                                <input required type="text" name="desc" id="desc" value="<?php echo $desc; ?>"
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                <input required type="text" name="client" id="client" value="<?php echo $client; ?>"
                                        ...
                                        <div class="row mt-2">
                                            <div class="col-md-6 mt-1">
                                                ...
                                                <input required type="number" name="tel" id="tel" value="<?php echo $tel; ?>"
                                                    placeholder="EJ: 3224213424" class="form-control">
                                            </div>
                                            <div class="col-md-6 mt-1">
                                                <label for="v-pago"><i class="fa fa-money" aria-hidden="true"></i>
                                                    Valor a Pagar:</label>
                                                <input required type="number" name="pago" id="pago" value="<?php echo $pago; ?>"
                                            ...
                                            <div class="col-md-6 mt-1">
                                                <label for="a"><i class="fa fa-money" aria-hidden="true"></i>
                                                    Cliente:</label>
                                                <input required type="number" name="idCliente" id="idCliente" value="<?php echo $idCliente; ?>"
                                                    placeholder="EJ: idCliente" class="form-control">
                                            </div>
                                            <div class="col-md-6 mt-1">
                                                <label for="v-pago"><i class="fa fa-money" aria-hidden="true"></i>
                                                    Mensajero:</label>
                                                <input required type="number" name="mensajero" id="mensajero" value="<?php echo $mensajero; ?>"
