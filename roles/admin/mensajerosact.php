...
if  (isset($_GET['id'])) {
    $id = $_GET['id'];
    $query = "SELECT `idEmpleado`, `documento`, `nombres`, `apellidos`, `correo`, `direccion`, `telefono`, `contraseña`, `estado`, `idRol`, r.nombreRol FROM empleados e INNER JOIN roles r ON e.idRol=r.idRoles WHERE idEmpleado=$id";
        ...
        <div class="main">
            ...
            <div class="card">
                <div class="row table-home">
                    <form action="EditarMensajero.php?id=<?php echo $_GET['id']; ?>" method="POST" novalidate>

                    <input required type="text" class="form-control" id="id" name="id"  value="<?php echo $idEmpleado; ?>"  hidden="true">
                        ...
                        <div class="modal-body">
                            ...
                            <div class="row mt-4">
                                ...
                                <div class="col-md-6 mt-4">
                            <label for="validationCustom03" class="form-label" for="nombre"> Rol:</label>
                            <select class="form-control" id="rol" name="rol" aria-label="Default select example">
                            <option selected  value="<?php echo $rol; ?>"><?php echo $nomRol; ?></option>
                        ...
                        <div class="btn-group" role="group" aria-label="Basic outlined example">
                            ...
                            <a href="mensajeros.php" class="btn btn-secondary" data-dismiss="modal">Cancelar</a>
                        </div>
                    </form>
                </div>
            </div>
